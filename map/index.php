<?
  ...
  */
 $dir = "../";
 $title = "Keyserver synchronisation map";
 include($dir."inc/header.inc.php");
 if(isset($title)) echo "<h1>{$title}</h1>";
?>
<p><a href="http://storage.sks-keyservers.net/map.png"><img src="http://storage.sks-keyservers.net/map-thumb.png" alt="Keyserver map thumbnail" /></a><br />(click for larger image)</p>
<?
